...
<Note>
The hash navigation script must be included after the main widget script. It automatically uses the same configuration attributes (API key, theme, custom paths, etc.) from the main widget script.
</Note>
